...
<html lang="en">
<head>
    <title>Usama Khan Portfolio</title>
    <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.html"><span>U</span>sama Khan</a>
            ...
            <div class="col-md-6 col-lg-6 pl-md-5 py-5">
                <div class="row justify-content-start pb-3">
                    <div class="col-md-12 heading-section ftco-animate">
                        ...
                        <p>This is my short information.</p>
                        <ul class="about-info mt-4 px-md-0 px-2">
                            <li class="d-flex"><span>Name:</span> <span>Usama Khan</span></li>
                            <li class="d-flex"><span>Date of birth:</span> <span>June 30, 1996</span></li>
                ...
                <div id="page-1" class="page one">
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <h2>Intermediate in Commerce</h2>
                            <span class="position">Govt. Degree College Korangi # 6.</span>
                        </div>
                    </div>
                    <div class="resume-wrap d-flex ftco-animate">
                        <div class="icon d-flex align-items-center justify-content-center">
                        ...
                        <div class="text pl-3">
                            ...
                            <span class="position">Pacific Grammar School</span>
                        </div>
                    </div>
                </div>
                ...
                <div id="page-2" class="page two">
                    ...
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <span class="position">A4 Logics</span>
                            <p>A small experience in wordpress, where i learn how to convert psd to wordpress theme
                                using AVADA.</p>
                        </div>
                    </div>
                    <div class="resume-wrap d-flex ftco-animate">
                        ...
                        <div class="text pl-3">
                            ...
                            <h2>Web Developer</h2>
                            <span class="position">Valuency</span>
                            <p>
                                Almost 01 year experience in there, I worked there on customize admin panel and content
                                management using CakePHP, and web designing using Gulp, Sass, Scss.
                            </p>
                        </div>
                    </div>
                    <div class="resume-wrap d-flex ftco-animate">
                    ...
                    <div id="page-3" class="page three">
                        ...
                        <div class="row progress-circle mb-5">
                            <div class="col-lg-4 mb-4">
                                <div class="bg-white rounded-lg shadow p-4">
                                    <h2 class="h5 font-weight-bold text-center mb-4">CSS3</h2>
                                    <!-- Progress bar 1 -->
                        ...
                        <span class="progress-bar border-primary"></span>
                            ...
                            <div class="col-lg-4 mb-4">
                                <div class="bg-white rounded-lg shadow p-4">
                                    <h2 class="h5 font-weight-bold text-center mb-4">Bootstrap 4</h2>
    ...
    <div class="container-fluid px-md-5">
        <div class="row justify-content-center py-5 mt-5">
            <div class="col-md-12 heading-section text-center ftco-animate">
                ...
                <p>I provides some services are as well</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 text-center d-flex ftco-animate">
                <a href="#" class="services-1 shadow">
                    ...
                    <div class="desc">
                        ...
                        <p>Every type of design I will assure you that i will give you a good and attractive design</p>
                    </div>
                </a>
            </div>
            <div class="col-md-4 text-center d-flex ftco-animate">
            ...
            <div class="col-md-4 text-center d-flex ftco-animate">
                <a href="#" class="services-1 shadow">
                    ...
                    <div class="desc">
                        ...
                        <p>I develop static and dynamic web application as per client requirements.</p>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-4 text-center d-flex ftco-animate">
                <a href="#" class="services-1 shadow">
                    ...
                    <div class="desc">
                        ...
                        <p>Yes I can deploy web sites on client choice domain.</p>
                    </div>
                </a>
            </div>
            <div class="col-md-4 text-center d-flex ftco-animate">
                <a href="#" class="services-1 shadow">
                    ...
                    <div class="desc">
                        ...
                        <p>Yes I will give you a unique brand name of your company and and any type of business.</p>
                    </div>
                </a>
            </div>
            <div class="col-md-4 text-center d-flex ftco-animate">
                <a href="#" class="services-1 shadow">
                    ...
                    <div class="desc">
                        <h3 class="mb-5">Logo Maker</h3>
                        <p>I makes attractive logo for your company and business</p>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="row no-gutters">
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center"
                    ...
                    <div class="text text-center p-4">
                        <h3><a href="#">Belgium Story Website for kids</a></h3>
                        <span>Web Design and developed</span>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center"
                    ...
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
                        <h3><a href="#">E-commerce web application</a></h3>
            ...
            <div class="col-md-4">
                <div class="project img ftco-animate d-flex justify-content-center align-items-center"
                    ...
                    <div class="overlay"></div>
                    <div class="text text-center p-4">
                        <h3><a href="#">Landing page for cheese company from Belgium</a></h3>
                        <span>Web Design and developed</span>
                    </div>
                </div>
            </div>
...
<section class="ftco-section ftco-no-pt ftco-no-pb ftco-counter img mb-5" id="section-counter">
    <div class="container-fluid px-md-5">
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
            <div class="col-md-7 heading-section text-center ftco-animate">
                ...
                <p>These are my contact information you can contact me.</p>
            </div>
        </div>
        ...
        <div class="row no-gutters block-9">
            ...
            <div class="col-md-6 d-flex">
                <div class="img" style="background-image: url(assets/images/about-2.jpg);"></div>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>You can also catch me on social media. Links are</p>
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        <li class="ftco-animate"><a href="https://www.facebook.com/usamakhan1002"><span
                                    class="icon-facebook"></span></a></li>
                        <li class="ftco-animate"><a href="https://www.instagram.com/usamakhan1002"><span
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>App Deployment</a></li>
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Branding</a></li>
                        <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Logo Maker</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md">
